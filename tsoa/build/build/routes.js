...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const fortuneController_1 = require("./../src/fortune/fortuneController");
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/fortune/:fortune', ...((0, runtime_1.fetchMiddlewares)(fortuneController_1.FortuneController)), ...((0, runtime_1.fetchMiddlewares)(fortuneController_1.FortuneController.prototype.getFortune)), function FortuneController_getFortune(request, response, next) {
        const args = {
            fortune: { "in": "path", "name": "fortune", "required": true, "dataType": "string" },
        };
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
            validatedArgs = getValidatedArgs(args, request, response);
            const controller = new fortuneController_1.FortuneController();
            const promise = controller.getFortune.apply(controller, validatedArgs);
